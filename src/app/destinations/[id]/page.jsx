...
const Details = async ({ params }) => {
  ...
  const {name,country,category,price,duration,date,image,description} = await getSingleDestinationsById(id);


  return <div className="max-w-6xl mx-auto p-6 bg-white min-h-screen font-sans">
      
      {/* Top Navigation / Action Bar */}
      <div className="flex justify-between items-center mb-6">
        <BackButton/>
        <div className="flex gap-3">
          <button className="flex items-center gap-2 border border-gray-300 px-4 py-1.5 rounded-md hover:bg-gray-50 transition">
            <FiEdit size={16} /> Edit
          </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-6 text-gray-900">Highlights</h2>
